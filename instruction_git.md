...
После создания локальной копии можно работать с репозиторием локально.

__Важно!__ Перед тем, как вносить свои изменения в форк корректно создать для этих изменений отдельную ветку и в дальнейшем именно в таком виде предложить изменения владельцу меняемого репозитория.
